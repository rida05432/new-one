      ...
      <div className="header-container">
        <button className="toggle-button" onClick={toggle}>
          {show ? (
            ...
            <FontAwesomeIcon icon={faShield} className="icon-white-bg" />
          )}
        </button>
        ...
        <ul className="sidebar-nav">
          ...
          >
            <Link to="/todo" className="sidebar-link">
              <FaRegListAlt className="sidebar-icon" /> <span>Progress</span>
            </Link>
          </li>
          <li
            className={`sidebar-item ${
          ...
          >
            <Link to="/topics" className="sidebar-link">
              <FaComments className="sidebar-icon" /> <span>Courses</span>
            </Link>
          </li>
          <li
            className={`sidebar-item ${
